...
owner_project_id INTEGER REFERENCES Users(user_id) ON DELETE CASCADE,
name VARCHAR NOT NULL,
...
date_add_to_project DATE NOT NULL,
...
executor_id INTEGER REFERENCES Users(user_id) ON DELETE CASCADE,
...
user_author_id INTEGER REFERENCES Users(user_id) ON DELETE CASCADE,
