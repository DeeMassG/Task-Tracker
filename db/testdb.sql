...
INSERT INTO public.project (project_id, creator_project_id, name, deadline, date_of_creation, description) VALUES (20, 11, 'тест проект после добавления записи в парт проджек', '2027-12-21 23:59:59', '2025-12-21', 'тест');
INSERT INTO public.project (project_id, creator_project_id, name, deadline, date_of_creation, description) VALUES (22, 12, 'Проектирование архитектуры приложения','2027-12-21 18:00:00', '2025-12-21', 'lallalalal123');
INSERT INTO public.project (project_id, creator_project_id, name, deadline, date_of_creation, description) VALUES (23, 12, '<p>lala</p>','2026-05-28 17:30:00', '2025-12-21', 'asdasd');
INSERT INTO public.project (project_id, creator_project_id, name, deadline, date_of_creation, description) VALUES (24, 11, 'тест1 фикс багов', '2027-04-11 16:45:00','2025-12-21', '3455235342');
INSERT INTO public.project (project_id, creator_project_id, name, deadline, date_of_creation, description) VALUES (25, 11, 'тест проект2 фикс багов', '2026-02-18 14:20:00','2025-12-21', 'фикс');
INSERT INTO public.project (project_id, creator_project_id, name, deadline, date_of_creation, description) VALUES (26, 11, 'фикс роута с добавлением юзеров в проект', '2027-08-29 12:00:00','2025-12-21', 'добавление юзеров в проект (создание совместного проекта с отдельными задачами для каждого пользователя)');
INSERT INTO public.project (project_id, creator_project_id, name, deadline, date_of_creation, description) VALUES (27, 13, 'Ещё один проект (тоже совместный для dimas)','2026-10-14 20:00:00', '2025-12-22', 'Здесь я от dimas2 создал проект, создам пару задач себе, добавлю dimas и пару задач назначу ему');
...
INSERT INTO role (role_id, role_name) VALUES (1, 'владелец');
INSERT INTO role (role_id, role_name) VALUES (2, 'участник');
